...
public class AudioMixerController2 {
    ...
    public AudioMixerController2(int channels, int sampleRate) {
...
//    }
        ...
        postToRenderThread(new Runnable() {
            ...
            public void run() {
                for (AudioMixerEvent listener : eventListeners) {
                    listener.onMixerInitialized(AudioMixerController2.this);
    ...
    private void notifyStarted() {
        postToRenderThread(new Runnable() {
            ...
            public void run() {
                for (AudioMixerEvent listener : eventListeners) {
                    listener.onMixerStarted(AudioMixerController2.this);
                }
            }
        });
    }
    ...
    private void notifyEnd() {
        postToRenderThread(new Runnable() {
            ...
            public void run() {
                for (AudioMixerEvent listener : eventListeners) {
                    listener.onMixerEnd(AudioMixerController2.this);
                }
            }
        });
    }
    ...
    public static interface AudioMixerEvent {
        void onMixerInitialized(AudioMixerController2 mixerController);

        void onMixerStarted(AudioMixerController2 mixerController);

        void onMixerEnd(AudioMixerController2 mixerController);
    }
